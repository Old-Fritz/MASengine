...
InterfaceShaderClass::InterfaceShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
InterfaceShaderClass::InterfaceShaderClass(const InterfaceShaderClass &)
{
}
InterfaceShaderClass::~InterfaceShaderClass()
{
...
void InterfaceShaderClass::Shutdown()
{
...
bool InterfaceShaderClass::Render(ID3D11DeviceContext * deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView * texture,
	float vertPercent, float horPercent, D3DXVECTOR4 selCol, float selIntensivity, float transparency)
{
	bool result;


	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, vertPercent, horPercent, selCol,
...
void InterfaceShaderClass::ShutdownShader()
{
...
bool InterfaceShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView * texture, float vertPercent, float horPercent, D3DXVECTOR4 selCol, float selIntensivity, float transparency)
{
	HRESULT result;
	...
	dataPtr2->selCol = selCol;
	dataPtr2->horPercent = horPercent;
	dataPtr2->selIntensivity = selIntensivity;
	dataPtr2->vertPercent = vertPercent;
	dataPtr2->transparency = transparency;
...
void InterfaceShaderClass::RenderShader(ID3D11DeviceContext * deviceContext, int indexCount)
{
